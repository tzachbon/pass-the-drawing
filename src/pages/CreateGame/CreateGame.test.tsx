...
import { authState, cleanup as firebaseCleanup, mockFirebase, signInWithRedirect } from '../../../tests/__mocks__/firebase'
import { cleanup as routerCleanup, mockRouter } from '../../../tests/__mocks__/react-router-dom'
...
describe('CreateGame', () => {
	...
	it('should do login process', async () => {
		...
		expect(driver.testkit().login().message().element()).toHaveTextContent('Logged in as test')
	})
})
